...
int AXConnectObject(IUnknown* Container, REFIID riid, IUnknown* Advisor, IConnectionPointContainer** p_IntConnPointContainer, IConnectionPoint** p_IntConnPoint)
{
	HRESULT hr = 0;
	unsigned long tid = 0;
